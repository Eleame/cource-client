      ...
      <div className="container">
        ...
        <div className={styles.about__inner}>
          <div className={`${styles.about__info} ${darkModeClass}`}>
            <p>
              Company &quot;AQUA JAZZ&quot; offers you various heating systems
              as well as spare parts for European gas and electric boilers. 99%
              of spare parts presented on the site constantly are kept in stock
              at our warehouse.
            </p>
            <p>
              The range of online store &quot;AQUA JAZZ&quot; includes in
              various heating systems as well as spare parts for boilers.
            </p>
          </div>
